...
class Ui_Playlist(object):
    def setupUi(self, Playlist):
        ...
        self.fm_bot.setFrameShape(QFrame.Shape.NoFrame)
        self.fm_bot.setFrameShadow(QFrame.Shadow.Plain)
        ...
        self.btn_add.setMinimumSize(QSize(30, 24))
        self.btn_add.setMaximumSize(QSize(30, 24))
        icon = QIcon()
        ...
        self.btn_open.setMinimumSize(QSize(30, 24))
        self.btn_open.setMaximumSize(QSize(30, 24))
        icon1 = QIcon()
        ...
        self.btn_save.setMinimumSize(QSize(30, 24))
        self.btn_save.setMaximumSize(QSize(30, 24))
        icon2 = QIcon()
        ...
        self.btn_up.setMinimumSize(QSize(30, 24))
        self.btn_up.setMaximumSize(QSize(30, 24))
        icon3 = QIcon()
        ...
        self.btn_down.setMinimumSize(QSize(30, 24))
        self.btn_down.setMaximumSize(QSize(30, 24))
        icon4 = QIcon()
